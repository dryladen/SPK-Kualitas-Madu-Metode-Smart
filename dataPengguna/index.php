                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn tombol-edit" href="edit.php?id=<?= $row['id_admin'] ?>"><i class="fas fa-pencil"></i></a>
                                        <a class="btn tombol-hapus" href="hapus.php?id=<?= $row['id_admin'] ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
